...
f_base = 1;
tau_f_base = 0.01005; % Membrane dynamic speed
tau_s_base = 20*tau_f_base; % Fast adaptation
tau_us_base =100*tau_f_base; % Slow adaptation
...
for k = 2:length(t)
    ...
    dxdt(1) = (-x(1,k-1) + g_f*tanh(x(1,k-1)) - g_s_plus*tanh(x(2,k-1)) + ...
        ...
        synapse(x(5,k-1), -0.2) - a_cross*tanh(x(7,k-1)) + input_hco1) / tau_f;
    ...
    dxdt(4) = (-x(4,k-1) + g_f*tanh(x(4,k-1)) - g_s_plus*tanh(x(5,k-1)) + ...
        ...
        synapse(x(2,k-1), -0.2) + a_cross*tanh(x(7,k-1)) + input_hco1) / tau_f;
    ...
    dxdt(7) = (-x(7,k-1) + g_f*tanh(x(7,k-1)) - g_s_plus*tanh(x(8,k-1)) + ...
        ...
        synapse(x(11,k-1), -0.2) - a_cross*tanh(x(1,k-1)) + input_hco2) / tau_f;
    ...
    dxdt(10) = (-x(10,k-1) + g_f*tanh(x(10,k-1)) - g_s_plus*tanh(x(11,k-1)) + ...
        ...
        synapse(x(8,k-1), -0.2) + a_cross*tanh(x(1,k-1)) + input_hco2) / tau_f;
